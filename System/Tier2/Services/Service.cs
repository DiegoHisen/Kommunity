    ...
    public static class Service
    {
        ...
        public static List<Petition> getPetitions(string command, string city)
        {
            ...
            try
            {
                ...
                list.Equals(JsonConvert.DeserializeObject<Petition>(fromServer)); // Is this line correct??
                return list;
            }
            catch
            {
        ...
        public static List<Petition> getUnapprovedPetitions(string city)
        {
            ...
            return getPetitions("getUnapprovedPetitions", city);
        ...
        public static List<Post> getPosts(string city)
        {
            ...
            try
            {
                ...
                list.Equals(JsonConvert.DeserializeObject<Post>(fromServer)); // Is this line correct??
                return list;
            }
            catch
            {
